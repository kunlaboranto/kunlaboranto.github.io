CREATE OR REPLACE VIEW GD_ALL_OBJECTS AS
...
CREATE OR REPLACE VIEW GD_USER_OBJECTS AS
SELECT * FROM GD_ALL_OBJECTS WHERE OWNER = USER_NAME()
;

CREATE PUBLIC SYNONYM USER_OBJECTS FOR US_GDMON.GD_USER_OBJECTS ;
