...
SELECT U.USER_NAME OWNER
  ...
  FROM SYSTEM_.SYS_USERS_ U
     , V$TABLESPACES C
     , V$SEGMENT D
       INNER JOIN SYSTEM_.SYS_TABLES_ T ON T.TABLE_OID = D.TABLE_OID AND T.TABLE_TYPE = 'T' AND D.SEGMENT_TYPE = 'TABLE' /* AND T.TABLE_NAME = 'xx' */
 WHERE 1 = 1
...
SELECT U.USER_NAME OWNER
  ...
  FROM SYSTEM_.SYS_USERS_ U
     , V$TABLESPACES C
     , V$SEGMENT D
       INNER JOIN SYSTEM_.SYS_TABLES_ T ON T.TABLE_OID = D.TABLE_OID AND T.TABLE_TYPE = 'T' /* AND T.TABLE_NAME = 'xx' */
