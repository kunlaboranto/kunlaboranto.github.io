    ...
    for (i=0; i<DISK_COUNT ; i++)
    {
        ...
        *******************************************/
        if (memcmp(UNAME, "SunOS", 5) == 0 || memcmp(UNAME, "OSF1", 4) == 0 || memcmp(UNAME, "Linux", 5) == 0)
            sprintf(_PCOM, "df -k \"%s\" | tail -1 | awk '{print $2 \" \" $3 \" \" $5}' | sed 's/%%//g'", DISK_DIR[i]);

        if (memcmp(UNAME, "HP-UX", 5) == 0 )
            sprintf(_PCOM, "bdf \"%s\" | tail -1 | awk '{print $2 \" \" $3 \" \" $5}' | sed 's/%%//g'", DISK_DIR[i]);

        if (memcmp(UNAME, "AIX", 3) == 0 )
            sprintf(_PCOM, "df -k \"%s\" | tail -1 | awk '{print $2 \" \" $2-$3 \" \" $4}' | sed 's/%%//g'", DISK_DIR[i]);
        ...
        ******************************************/
        ...
        {
            if (memcmp(UNAME, "SunOS", 5) == 0 || memcmp(UNAME, "OSF1", 4) == 0 || memcmp(UNAME, "Linux", 5) == 0)
                sprintf(_PCOM, "df -k \"%s\" | tail -1 | awk '{print $1 \" \" $2 \" \" $4}' | sed 's/%%//g'", DISK_DIR[i]);

            if (memcmp(UNAME, "HP-UX", 5) == 0 )
                sprintf(_PCOM, "bdf \"%s\" | tail -1 | awk '{print $1 \" \" $2 \" \" $4}' | sed 's/%%//g'", DISK_DIR[i]);

            if (memcmp(UNAME, "AIX", 3) == 0 )
                sprintf(_PCOM, "df -k \"%s\" | tail -1 | awk '{print $1 \" \" $1-$2 \" \" $3}' | sed 's/%%//g'", DISK_DIR[i]);
